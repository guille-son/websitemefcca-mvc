    ...
    <div class="contenedor_direccion clearfix">
        <div class="direccion_principal">
            <div class="imagen_destacada">
                <img src="<?php echo $servidor . $direccionEstu[0]['imagen'];?>" alt="Imagen Direccion">
            </div>
                ...
                <div class="sidebar_noticias">
                    ...
                    <div class="noticia">
                        ...
                        <div class="pie_noticia">
                            ...
                            <a href="<?php echo $valueSidebar['facebook']; ?>" target="_blank" class="facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
                            <a href="<?php echo $valueSidebar['instagram']; ?>" target="_blank" class="instagram"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                            <a href="<?php echo $valueSidebar['twitter']; ?>" target="_blank" class="twitter"><i class="fab fa-twitter" aria-hidden="true"></i></a>
                            </nav>
