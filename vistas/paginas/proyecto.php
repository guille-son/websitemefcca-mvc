<?php
    ...
    $proyectoEstu = ControladorEstructura::ctrMostrarEstructura($id[$id_position]);
...
<main id="videosSinPaginar" class="seccion_direccion seccion contenedor videoYoutube">
    ...
    <div class="encabezado_direccion">
        <h2><?php echo $proyectoEstu[0]['titulo'];?></h2>
    </div>

    <div class="contenedor_direccion clearfix">
        <div class="direccion_principal">
            <div class="imagen_destacada">
                <img src="<?php echo $servidor . $proyectoEstu[0]['imagen'];?>" alt="Imagen Direccion">
            </div>
            <div class="texto"><?php echo $proyectoEstu[0]['descripcion'];?></div>
        </div>
        ...
        <div class="sidebar_direcciones">
            ...
            <div class="centrar_boton_seccion padding_boton_seccion">
                <div>
                    <a href="<?php echo $ruta; ?>videos/<?php echo $id[$id_position] ?>"
                        class="boton btn_estilo_uno">Videos <i class="fas fa-arrow-right icono_boton"></i></a>
                </div>
            </div>
            <?php } ?>
                ...
                <div class="noticia">
                    ...
                    <div class="contenido_noticia">
                        <div class="encabezado_noticia">
                            ...
                            <div class="lista_detalle_noticia">
                                <p><i class="far fa-calendar" aria-hidden="true"></i>
                                    <span><?php echo $valueSidebar['fecha']; ?></span></p>
                                <p><i class="far fa-clock" aria-hidden="true"></i>
                                    <span><?php echo $valueSidebar['hora']; ?></span></p>
                                <p><i class="far fa-user" aria-hidden="true"></i>
                                    <span><?php echo $valueSidebar['nombre_completo'] ?></span></p>
                            </div>
                        </div>
                        ...
                        <div class="pie_noticia">
                            ...
                            <?php 
                            $url = ControladorUrlAmigable::ctrUrlAmigable($valueSidebar['titulo']); 
                            $tipo = 'noticia-';
                            $pleca = '/';
                            ?>
...
<script>
document.title = '<?php echo $proyectoEstu[0]['titulo']; ?>';
</script>
